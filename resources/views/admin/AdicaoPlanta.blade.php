                  ...
                  <div class="col col-md-8">
                    <div class="col col-md-7 ">
                      <div class="form-group">    
                        ...
                        <input  type="text" class="form-control" id="nomePopular" name="nomePopular" aria-describedby="emailHelp" placeholder="Coloque o nome popular da planta">
                      </div>
                    </div>
                    ...
                    <div class="col col-md-7">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nomeCientifico" name="nomeCientifico" aria-describedby="emailHelp" placeholder="Coloque o nome Científico da planta">
                      </div>
                      <div class="form-group">

                          <label for="corFolha"><h3>Cor Folha</h3></label>

                          <input type="text" class="form-control" id="corFolha" name="corFolha" placeholder="Rosa/Amarela">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="corFlor" name="corFlor" placeholder="Rosa/Amarela">
                        </div>
